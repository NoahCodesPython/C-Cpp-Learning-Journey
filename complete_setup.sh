...
# We're already in the C-Cpp-Learning-Journey directory, so no need to cd

# Create all week directories first
echo "📁 Creating all week directories..."

# Week 1: C Fundamentals
mkdir -p "Week-01-C-Fundamentals/Day-01-Hello-College"
mkdir -p "Week-01-C-Fundamentals/Day-02-Student-Info-Card"
mkdir -p "Week-01-C-Fundamentals/Day-03-Quick-Calculator"
mkdir -p "Week-01-C-Fundamentals/Day-04-Grade-Classifier"
mkdir -p "Week-01-C-Fundamentals/Day-05-Pattern-Printer"
mkdir -p "Week-01-C-Fundamentals/Day-06-Marks-Analyzer"
mkdir -p "Week-01-C-Fundamentals/Day-07-Number-Guesser"
mkdir -p "Week-01-C-Fundamentals/Week-01-Project-Adventure-Game"

# Week 2: C Intermediate
mkdir -p "Week-02-C-Intermediate/Day-08-Function-Library"
mkdir -p "Week-02-C-Intermediate/Day-09-String-Toolkit"
mkdir -p "Week-02-C-Intermediate/Day-10-Pointer-Playground"
mkdir -p "Week-02-C-Intermediate/Day-11-Memory-Manager"
mkdir -p "Week-02-C-Intermediate/Day-12-Student-Database"
mkdir -p "Week-02-C-Intermediate/Day-13-File-Organizer"
mkdir -p "Week-02-C-Intermediate/Day-14-Mini-Banking-System"
mkdir -p "Week-02-C-Intermediate/Week-02-Project-Student-Management"

# Week 3: C++ Introduction
mkdir -p "Week-03-Cpp-Introduction/Day-15-Cpp-Converter"
mkdir -p "Week-03-Cpp-Introduction/Day-16-Class-Calculator"
mkdir -p "Week-03-Cpp-Introduction/Day-17-Student-Management"
mkdir -p "Week-03-Cpp-Introduction/Day-18-Library-System"
mkdir -p "Week-03-Cpp-Introduction/Day-19-Shape-Factory"
mkdir -p "Week-03-Cpp-Introduction/Day-20-Polymorphism-Demo"
mkdir -p "Week-03-Cpp-Introduction/Day-21-Advanced-Library"
mkdir -p "Week-03-Cpp-Introduction/Week-03-Project-Banking-App"

# Week 4: Advanced C++
mkdir -p "Week-04-Advanced-Cpp/Day-22-Vector-Toolkit"
mkdir -p "Week-04-Advanced-Cpp/Day-23-Algorithm-Explorer"
mkdir -p "Week-04-Advanced-Cpp/Day-24-Template-Library"
mkdir -p "Week-04-Advanced-Cpp/Day-25-Exception-Handler"
mkdir -p "Week-04-Advanced-Cpp/Day-26-File-Stream-Manager"
mkdir -p "Week-04-Advanced-Cpp/Day-27-Memory-Optimizer"
mkdir -p "Week-04-Advanced-Cpp/Day-28-Capstone-Project"
mkdir -p "Week-04-Advanced-Cpp/Week-04-Project-Desktop-Utility"

# Resource directories
mkdir -p "Resources/cheat-sheets"
mkdir -p "Resources/references"
mkdir -p "Resources/templates"
mkdir -p "Resources/images"
mkdir -p "Progress-Tracking"
mkdir -p "Exercises/exercism-c"
mkdir -p "Exercises/exercism-cpp"
mkdir -p "Exercises/additional-practice"
mkdir -p "Scripts"
mkdir -p "docs"

echo "✅ All directories created successfully!"
echo ""
echo "📝 Creating template files for all days and weeks..."

# Function to create complete day template files
create_day_files() {
    local day_path=$1
    local day_num=$2
    ...
    local concepts=$4
    local gfg_link=$5
    local exercism_exercise=$6
    local file_ext=$7
    
    echo "  📄 Creating Day $day_num: $project_name files..."
...
## 🎯 Today's Goal
Master $concepts through hands-on implementation of $project_name.
...
**Primary Link**: $gfg_link

## 💻 Exercism Exercise
**Exercise**: $exercism_exercise  
...
DAYREADME
    ...
    sed -i "s/\$day_num/$day_num/g" "$day_path/README.md"
    sed -i "s/\$project_name/$project_name/g" "$day_path/README.md"
    sed -i "s/\$concepts/$concepts/g" "$day_path/README.md"
    sed -i "s|\$gfg_link|$gfg_link|g" "$day_path/README.md"
    sed -i "s/\$exercism_exercise/$exercism_exercise/g" "$day_path/README.md"
...
using namespace std;"
    ...
    cout << \"\\nImplementation coming soon...\" << endl;"
    else
    ...
    # Create main code file
    cat > "$day_path/main.$file_ext" << MAINCODE
/*
=======================================================
Day $day_num: $project_name
=======================================================
...
MAINCODE
    ...
    # Create project completion tracker
    cat > "$day_path/project_done.md" << 'PROJECTDONE'
...
PROJECTDONE
    ...
    # Replace placeholders in project_done.md
    sed -i "s/\$day_num/$day_num/g" "$day_path/project_done.md"
    sed -i "s/\$project_name/$project_name/g" "$day_path/project_done.md"
    sed -i "s/\$concepts/$concepts/g" "$day_path/project_done.md"

    # Create output documentation
    cat > "$day_path/output.txt" << 'OUTPUTDOC'
Day $day_num: $project_name - Output Documentation
================================================
...
**Actual Output**:
[Paste actual output here after implementation]
...
- **C**: `gcc main.c -o day$day_num`
- **C++**: `g++ main.cpp -o day$day_num`
...
---
**Output Status**: [ ] 🔴 Not Started [ ] 🟡 In Progress [ ] 🟢 Complete
OUTPUTDOC

    # Replace placeholders in output.txt
    sed -i "s/\$day_num/$day_num/g" "$day_path/output.txt"
    sed -i "s/\$project_name/$project_name/g" "$day_path/output.txt"
...
NOTESDOC
    ...
    # Replace placeholders in notes.md
    sed -i "s/\$day_num/$day_num/g" "$day_path/notes.md"
    sed -i "s/\$project_name/$project_name/g" "$day_path/notes.md"
    sed -i "s/\$concepts/$concepts/g" "$day_path/notes.md"
    sed -i "s|\$gfg_link|$gfg_link|g" "$day_path/notes.md"
    sed -i "s/\$exercism_exercise/$exercism_exercise/g" "$day_path/notes.md"
    sed -i "s/\$file_ext/$file_ext/g" "$day_path/notes.md"
}

# Function to create weekly project files
create_weekly_project() {
    local week_path=$1
    local week_num=$2
    local project_name=$3
    local description=$4
    
    echo "  📋 Creating Week $week_num Major Project: $project_name..."
    
    cat > "$week_path/README.md" << 'WEEKREADME'
...
This project integrates all Week $week_num concepts:
...
WEEKREADME
    ...
    sed -i "s/\$week_num/$week_num/g" "$week_path/README.md"
    sed -i "s/\$project_name/$project_name/g" "$week_path/README.md"
    sed -i "s/\$description/$description/g" "$week_path/README.md"

    cat > "$week_path/project_done.md" << 'WEEKDONE'
...
## 🎯 Week $week_num Learning Integration
...
WEEKDONE
    ...
    # Replace placeholders
    sed -i "s/\$week_num/$week_num/g" "$week_path/project_done.md"
    sed -i "s/\$project_name/$project_name/g" "$week_path/project_done.md"
}

# Create all day files with specific project details
echo ""
echo "🔨 Creating Week 1: C Fundamentals..."
create_day_files "Week-01-C-Fundamentals/Day-01-Hello-College" "1" "Hello College Introduction" "Basic C syntax, printf, program structure" "https://www.geeksforgeeks.org/c-programming-language/" "Hello World" "c"

create_day_files "Week-01-C-Fundamentals/Day-02-Student-Info-Card" "2" "Student Information System" "Variables, data types, scanf, user input" "https://www.geeksforgeeks.org/variables-in-c/" "Leap Year" "c"

create_day_files "Week-01-C-Fundamentals/Day-03-Quick-Calculator" "3" "Multi-Operation Calculator" "Operators, expressions, mathematical operations" "https://www.geeksforgeeks.org/operators-c-c/" "Gigasecond" "c"

create_day_files "Week-01-C-Fundamentals/Day-04-Grade-Classifier" "4" "Academic Grade Classification System" "Conditional statements, if-else, decision making" "https://www.geeksforgeeks.org/decision-making-c-c-else-nested-else/" "Raindrops" "c"

create_day_files "Week-01-C-Fundamentals/Day-05-Pattern-Printer" "5" "Artistic Pattern Generator" "Loops, nested loops, pattern logic" "https://www.geeksforgeeks.org/loops-in-c-and-cpp/" "Collatz Conjecture" "c"

create_day_files "Week-01-C-Fundamentals/Day-06-Marks-Analyzer" "6" "Statistical Marks Analysis Tool" "Arrays, functions, statistical calculations" "https://www.geeksforgeeks.org/arrays-in-c-cpp/" "Armstrong Numbers" "c"

create_day_files "Week-01-C-Fundamentals/Day-07-Number-Guesser" "7" "Interactive Number Guessing Game" "Random numbers, game logic, loops with conditions" "https://www.geeksforgeeks.org/rand-and-srand-in-ccpp/" "Isogram" "c"

echo "🔨 Creating Week 2: C Intermediate..."
create_day_files "Week-02-C-Intermediate/Day-08-Function-Library" "8" "Custom Function Library" "Functions, modularity, parameters and return" "https://www.geeksforgeeks.org/functions-in-c/" "Hamming Distance" "c"

create_day_files "Week-02-C-Intermediate/Day-09-String-Toolkit" "9" "Advanced String Manipulation" "Strings, string.h library, character arrays" "https://www.geeksforgeeks.org/strings-in-c-2/" "Acronym" "c"

create_day_files "Week-02-C-Intermediate/Day-10-Pointer-Playground" "10" "Pointer Operations Demo" "Pointers, memory addresses, pointer arithmetic" "https://www.geeksforgeeks.org/pointers-in-c-and-c-set-1-introduction-arithmetic-and-array/" "Nucleotide Count" "c"

create_day_files "Week-02-C-Intermediate/Day-11-Memory-Manager" "11" "Dynamic Memory Management" "malloc, calloc, realloc, free, dynamic allocation" "https://www.geeksforgeeks.org/dynamic-memory-allocation-in-c-using-malloc-calloc-free-and-realloc/" "Word Count" "c"

create_day_files "Week-02-C-Intermediate/Day-12-Student-Database" "12" "File-Based Student Database" "Structures, file I/O, data persistence" "https://www.geeksforgeeks.org/structures-c/" "Allergies" "c"

create_day_files "Week-02-C-Intermediate/Day-13-File-Organizer" "13" "Automated File Organization" "File operations, FILE pointers, file manipulation" "https://www.geeksforgeeks.org/file-handling-c/" "Roman Numerals" "c"

create_day_files "Week-02-C-Intermediate/Day-14-Mini-Banking-System" "14" "Complete Mini Banking App" "Integration of all C concepts, complex project" "https://www.geeksforgeeks.org/c-programming-language/" "Clock" "c"

echo "🔨 Creating Week 3: C++ Introduction..."
create_day_files "Week-03-Cpp-Introduction/Day-15-Cpp-Converter" "15" "C to C++ Migration Tool" "C++ basics, iostream, namespace" "https://www.geeksforgeeks.org/c-plus-plus/" "Hello World" "cpp"

create_day_files "Week-03-Cpp-Introduction/Day-16-Class-Calculator" "16" "Object-Oriented Calculator" "Classes, objects, methods, encapsulation" "https://www.geeksforgeeks.org/c-classes-and-objects/" "Leap Year" "cpp"

create_day_files "Week-03-Cpp-Introduction/Day-17-Student-Management" "17" "Class-Based Student Management" "Constructors, destructors, object lifecycle" "https://www.geeksforgeeks.org/constructors-c/" "Gigasecond" "cpp"

create_day_files "Week-03-Cpp-Introduction/Day-18-Library-System" "18" "OOP Library System" "Access specifiers, data hiding, encapsulation" "https://www.geeksforgeeks.org/access-specifiers-in-c/" "Raindrops" "cpp"

create_day_files "Week-03-Cpp-Introduction/Day-19-Shape-Factory" "19" "Inheritance-Based Shape System" "Inheritance, base classes, derived classes" "https://www.geeksforgeeks.org/inheritance-in-c/" "Collatz Conjecture" "cpp"

create_day_files "Week-03-Cpp-Introduction/Day-20-Polymorphism-Demo" "20" "Runtime Polymorphism Demo" "Virtual functions, polymorphism, dynamic binding" "https://www.geeksforgeeks.org/virtual-function-cpp/" "Armstrong Numbers" "cpp"

create_day_files "Week-03-Cpp-Introduction/Day-21-Advanced-Library" "21" "Advanced OOP Library" "Advanced OOP, operator overloading" "https://www.geeksforgeeks.org/object-oriented-programming-in-cpp/" "Isogram" "cpp"

echo "🔨 Creating Week 4: Advanced C++..."
create_day_files "Week-04-Advanced-Cpp/Day-22-Vector-Toolkit" "22" "STL Vector Operations" "STL containers, vector operations, iterators" "https://www.geeksforgeeks.org/vector-in-cpp-stl/" "Hamming Distance" "cpp"

create_day_files "Week-04-Advanced-Cpp/Day-23-Algorithm-Explorer" "23" "STL Algorithms Demo" "STL algorithms, iterators, functional programming" "https://www.geeksforgeeks.org/algorithms-library-c-stl/" "Acronym" "cpp"

create_day_files "Week-04-Advanced-Cpp/Day-24-Template-Library" "24" "Generic Programming with Templates" "Function templates, class templates, generic programming" "https://www.geeksforgeeks.org/templates-cpp/" "Nucleotide Count" "cpp"

create_day_files "Week-04-Advanced-Cpp/Day-25-Exception-Handler" "25" "Exception Handling System" "Exception handling, try-catch, custom exceptions" "https://www.geeksforgeeks.org/exception-handling-c/" "Word Count" "cpp"

create_day_files "Week-04-Advanced-Cpp/Day-26-File-Stream-Manager" "26" "Advanced File Stream Operations" "File streams, fstream, binary files" "https://www.geeksforgeeks.org/file-handling-through-c-classes/" "Allergies" "cpp"

create_day_files "Week-04-Advanced-Cpp/Day-27-Memory-Optimizer" "27" "Smart Pointer Memory Management" "Smart pointers, RAII, modern C++ memory" "https://www.geeksforgeeks.org/smart-pointers-cpp/" "Roman Numerals" "cpp"

create_day_files "Week-04-Advanced-Cpp/Day-28-Capstone-Project" "28" "Advanced C++ Application" "Complete application using all advanced C++ features" "https://www.geeksforgeeks.org/c-plus-plus/" "Space Age" "cpp"

# Create weekly projects
echo ""
echo "📋 Creating Weekly Major Projects..."
create_weekly_project "Week-01-C-Fundamentals/Week-01-Project-Adventure-Game" "1" "Text-based Adventure Game System" "Create an engaging interactive text-based adventure game integrating all C fundamentals"

create_weekly_project "Week-02-C-Intermediate/Week-02-Project-Student-Management" "2" "Comprehensive Student Management System" "Develop a complete student management system with file-based persistence and advanced C concepts"

create_weekly_project "Week-03-Cpp-Introduction/Week-03-Project-Banking-App" "3" "Object-Oriented Banking Application" "Design a full-featured banking application using OOP principles and inheritance"

create_weekly_project "Week-04-Advanced-Cpp/Week-04-Project-Desktop-Utility" "4" "Multi-Feature Desktop Utility Tool" "Create a sophisticated utility showcasing advanced C++ features and STL usage"

# Create resource files
echo ""
echo "📚 Creating resource files..."

cat > "Resources/cheat-sheets/c_cheatsheet.md" << 'CCHEAT'
